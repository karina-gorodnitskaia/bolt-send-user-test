...
function Row({ name = "Aisha Bello", rating }: { name?: string; rating?: string }) {
  return (
      ...
      >
        ...
        <div className="flex-1 flex flex-col min-w-0">
          <p
            ...
            style={{ fontFeatureSettings: "'cv03', 'cv04', 'lnum', 'pnum'" }}
          >
            {headerText ?? (collected ? '₦3,000 collected' : 'Collect ₦3,000')}
          </p>
    ...
    <div style={{ width: '100%', paddingTop: 12 }}>
      <div style={{
        ...
        <p style={{ fontFamily: "'Inter Variable', sans-serif", fontSize: 14, lineHeight: '20px', color: '#191F1C', margin: 0, fontFeatureSettings: "'cv03', 'cv04'" }}>
          Parcel and <strong style={{ fontWeight: 650 }}>₦3,000</strong> payment collected
        </p>
      </div>
      <Frame5
          ...
          {isOpen && (
            <div className="w-full" style={{ paddingBottom:
              ...
              <DeliveryDetails
                ...
                pickupAddress="3 Marina Road, Lagos Island"
                dropoffAddress="Ozumba Mbadiwe Avenue 10, Victoria Island"
                cityName="Lagos"
...
export default function AppNigeria() {
          ...
          {!isAccepted && (
            ...
            >
              <AcceptanceScreen
                ...
                priceText="₦3,000"
                senderName="Aisha Bello"
                pickupAddress="3 Marina Road, Lagos Island, Lagos"
                dropoffAddress="Ozumba Mbadiwe Avenue 10, Victoria Island, Lagos, Nigeria"
              />
            </motion.div>
          )}
        </AnimatePresence>
                  ...
                  {isArrivedAtDropoff && isCollectingFromReceiver ? (
                    <>
                      ...
                      <CashChipBanner
                        ...
                        error={chipError}
                        headerText={receiverCashCollected ? '₦3,000 collected' : 'Collect ₦3,000'}
                        onToggle={() => {
